      ...
      <div class="component-wrapper">
          ...
          <div class="inner-wrapper">
            ...
            <div class="overflow-wrapper">
              <a class="slide" href=""><img
                  src="https://pbs.twimg.com/media/Fcv-IMrX0AcL-JG?format=jpg&name=4096x4096" /></a>
              <a class="slide" href=""><img src="https://ibighit.com/bts/images/profile/proof/member/bts-pc.jpg" /></a>
              <a class="slide" href=""><img
                  src="https://pbs.twimg.com/media/EKWFnyUUcAAZBDV?format=jpg&name=4096x4096" /></a>
              <a class="slide" href=""><img
                  src="https://lv2-cdn.azureedge.net/twice/56882cc43bdc4305b0a0face7794ab2c-00.%E1%84%83%E1%85%A1%E1%86%AB%E1%84%8E%E1%85%A6-%E1%84%8F%E1%85%A5%E1%86%AB%E1%84%89%E1%85%A6%E1%86%B82.jpg" /></a>
            </div>
          </div>
        </div>
        ...
        <transition-group name="fade">
          <div v-for="blog in blogs" v-bind:key="blog.id" class="blog-list">
            ...
            <div v-on:click="navigateTo('/front/read/'+ blog.id)"><a href="">
                <h3>{{ blog.title }}</h3>
              </a></div>
            ...
            <div class="blog-info">
              ...
              <p>
                <button class="btn btn-dark" v-on:click="navigateTo('/front/read/'+ blog.id)">
        ...
        <div id="blog-list-bottom">
          <div class="blog-load-finished" v-if="blogs.length === results.length && results.length > 0">โหลดข้อมูลครบแล้ว
          </div>
        </div>
      </div>
    </div>
