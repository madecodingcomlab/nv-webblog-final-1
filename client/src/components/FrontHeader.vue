        ...
        <div class="login-wrapperr">
          ...
          <form v-on:submit.prevent="clientRegister" class="formhorizontal">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input required placeholder="email" type="email" v-model="client.email" class="form-control" /><br>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input required type="password" placeholder="password" v-model="client.password"
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input required type="text" placeholder="name" v-model="client.name" class="form-control" /><br>
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input required type="text" placeholder="lastname" v-model="client.lastname" class="form-control" /><br>
              </div>
              <br>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input required type="text" placeholder="address" v-model="client.address " class="form-control" /><br>
              </div>
          ...
          <form v-on:submit.prevent="clientLogin" class="formhorizontal">
            ...
            <div class="form-group">
              <div class="col-md-offset-3 col-md-9">
                ...
                <button v-on:click.prevent="showLogin = false" class="btn btn-danger btn-sm" type="button">
                  <i class="fas fa-timescircle"></i> Close
                </button>
              </div>
            </div>
